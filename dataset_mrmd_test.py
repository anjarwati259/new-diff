...
def load_dataset(dataname, idx=0, mask_type='MCAR', ratio='30', noise_std=0.01):
    ...
    # ── Latih SupervisedLearnableEmbeddingModel LANGSUNG di TRAIN_FULL ─────
    ...
    print('[Embedding] Melatih SupervisedLearnableEmbeddingModel '
          '(classification + reconstruction loss) LANGSUNG pada TRAIN_FULL ...')
    ...
    emb_model = train_supervised_embedding_model(
        ...
        labels        = full_train_labels, # label TRAIN_FULL
        cat_dims      = all_dims,
        emb_sizes     = emb_sizes,
        n_classes     = n_classes,
        device        = device,
        ...
        noise_std     = noise_std,
        patience      = 40,
        mask_array    = train_all_mask,    # mask TRAIN_FULL — posisi missing dikecualikan dari recon loss
    )
    t_emb_end = time.time()
